...
#7.Gradient Descent
####################
#we can use scikit learn to clean up the data. The rest is pretty much the way i have been doing it

#8.Regularization
####################
#Ridge Regression and LASSO: https://www.analyticsvidhya.com/blog/2016/01/complete-tutorial-ridge-lasso-regression-python/
#Elastic net: https://stats.stackexchange.com/questions/184029/what-is-elastic-net-regularization-and-how-does-it-solve-the-drawbacks-of-ridge
#watch lecture number 23 for code

#9.Polynomial Regression
########################
# More details: https://stats.stackexchange.com/questions/58739/polynomial-regression-using-scikit-learn
from sklearn.preprocessing import PolynomialFeatures
from sklearn.linear_model import LinearRegression
from sklearn.metrics import r2_score
df = pd.read_csv('housing.data',delim_whitespace=True,header=None,names=["CRIM","ZN","INDUS","CHAS","NOX","RM","AGE","DIS","RAD","TAX","PTRATIO","B","LSTAT","MEDV"])
X_boston = df['DIS'].values
y_boston = df['NOX'].values
plt.scatter(X_boston,y_boston)

poly_reg = PolynomialFeatures(degree=2) #degree 2 means quadratic model
X_polyb = poly_reg.fit_transform(X_boston.reshape(-1,1))
lin_reg2 = LinearRegression()

lin_reg2.fit(X_polyb,y_boston)
...
print("R2 score = {:.2f}".format(r2_score(y_boston,lin_reg2.predict(X_polyb))))
# linear model r2 = 0.50, quadratic r2 = 0.70, cubic model overfits r2 = 0.71

#10.Data Preprocessing
########################
#10.1 Standardization/mean removal/variance scaling
#10.2 min max or scaling features to range: Scale data to [0,1] range
#10.3 Normalization: l1 and l2, scaling individual samlples to have unit norm
#10.4 Binarization: Thresholding numerical data to get boolean values
